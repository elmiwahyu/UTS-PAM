package com.dayeeen.PizzaProject;
...
public class SecondActivity extends AppCompatActivity {
    ...
    TextView store_name;
    String cibiru = "Cibiru";
    String cihampelas = "Cihampelas";
    Uri gmmIntentUri;
    Group location_maps;
    Button send_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Objects.equals(receiver_store_name, cibiru)) {
            store_location.setImageResource(R.drawable.cibiru);
            store_name.setText(receiver_store_name);
            gmmIntentUri = Uri.parse("geo:-6.923523, 107.715027=cibiru");
        } else if (Objects.equals(receiver_store_name, cihampelas)) {
